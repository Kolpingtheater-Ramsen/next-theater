  ...
  return (
    <html lang='de' data-theme='dark' suppressHydrationWarning>
      ...
      >
        ...
        <footer className='bottom-0 border-t border-site-700 py-8 text-sm text-site-300 bg-site-900 backdrop-blur supports-[backdrop-filter]:bg-site-900/95'>
          <div className='mx-auto max-w-6xl px-4 flex flex-wrap items-center justify-between gap-4'>
            ...
            <div className='flex items-center gap-4'>
              <Link href='/presse' className='hover:text-kolping-400 focus:outline-none focus:ring-2 focus:ring-kolping-400 focus:ring-offset-2 focus:ring-offset-site-900 rounded px-1 transition-colors hidden md:inline'>
                Presse
              </Link>
